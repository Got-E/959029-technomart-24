...
#### 2. Создайте форк сделано

[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/959029-technomart-24) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
...
#### 3. Клонируйте репозиторий на свой компьютер сделано
